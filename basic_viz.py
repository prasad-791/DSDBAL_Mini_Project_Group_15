...
fig,ax = mviz.plot_pitch()
ax.plot( tracking_home['Home_6_x'].iloc[:1500], tracking_home['Home_6_y'].iloc[:1500], 'r.', MarkerSize=1)
ax.plot( tracking_away['Away_17_x'].iloc[:1500], tracking_away['Away_17_y'].iloc[:1500], 'b.', MarkerSize=1)
